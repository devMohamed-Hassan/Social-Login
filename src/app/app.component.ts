...
export class AppComponent {
  ...
  handelSignIn(idToken: any) {
    ...
    //   console.log(`Data from the handleSignIn method`   , {data});
      
    // }
    // )


    this._authService.registerWithGmail({ idToken }).subscribe(data => {
      console.log(`Data from the registerWithGmail method`   , {data});
      }
    )
  }
}
